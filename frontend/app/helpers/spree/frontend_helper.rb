  ...
  module FrontendHelper
    ...
    def spree_breadcrumbs(taxon, _separator = "", product = nil)
      ...
      if taxon
        ...
        crumbs << ancestors.each_with_index.map { |ancestor, index|
    ...
    def checkout_progress(numbers: false)
      ...
      items = states.each_with_index.map { |state, i|
    ...
    def flash_messages(opts = {})
      ...
      flash.to_h.except("order_completed").each do |msg_type, text|
        ...
        flashes << content_tag(:div, class: "alert alert-#{class_for(msg_type)} mb-0") {
    ...
    def taxons_tree(root_taxon, current_taxon, max_level = 1)
      ...
      content_tag :div, class: "list-group" do
        taxons = root_taxon.children.map { |taxon|
    ...
    def available_option_types
      @available_option_types ||= Rails.cache.fetch("available-option-types/#{available_option_types_cache_key}") {
